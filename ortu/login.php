...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href=""><b>Login Orang Tua/Wali</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      ...
      if (isset($_POST['submit'])) {
        ...
        $cek = mysqli_query($conn, "SELECT * FROM user_akun WHERE username = '" . $user . "' ");
        if (mysqli_num_rows($cek) > 0) {
          ...
          if (md5($pass) == $d->password) {
            ...
            $_SESSION['uid'] = $d->id;
            $_SESSION['uname'] = $d->nama_ortu;
            $_SESSION['uid_santri'] = $d->id_santri;
            $_SESSION['uid_ortu'] = $d->id_ortu;
