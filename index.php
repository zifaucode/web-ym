    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          ...
          <a href="index.php"><img src="depan/assets/img/logo-web.png" class="logo" alt="" height="70px" width="190px"></a>
            ...
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Profile Yayasan</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  ...
                  <li><a href="kegiatan-yayasan.php">Kegiatan</a></li>
                  <li><a href="program-kerja.php">Program Kerja</a></li>
                  <li><a href="informasi.php">Informasi</a></li>
                </ul>
              </li>
              <li><a class="nav-link scrollto" href="pendidikan.php">Pendidikan</a></li>
              ...
              <li class="dropdown"><a href="#"><span>Pendaftaran</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  <li><a href="pendaftaran.php">Informasi Penerimaan Santri</a></li>
                </ul>
              </li>
  ...
  ?>
      ...
      <main id="main">
        ...
        <section id="call-to-action">
          <div class="container text-center" data-aos="zoom-in">
            <h3>Ketua Yayasan</h3>
            <img src="uploads/pimpinan/<?= $ym['foto_pimpinan'] ?>" class="img-fluid" alt="" width="150px">
            <br>
            <br>
            <h3><?= $ym['nama_pimpinan'] ?></h3>
            <br>
            <p> <?= $ym['sambutan_pimpinan'] ?></p>
            ...
            ?>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                  <div class="portfolio-wrap">
                    <figure>
                      <img src="uploads/galery/<?= $gbr['gambar'] ?>" class="img-fluid" alt=""><?= $gbr['keterangan'] ?>
