    ...
    <div class="box-body">
        <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="gambar_slide3" required>
            </div>
        ...
        if (isset($_POST['submit'])) {
            $filename = $_FILES['gambar_slide3']['name'];
            $tmpname = $_FILES['gambar_slide3']['tmp_name'];
            $filesize = $_FILES['gambar_slide3']['size'];
