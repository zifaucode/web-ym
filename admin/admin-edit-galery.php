...
?>
<?php
$santri = mysqli_query($conn, "SELECT * FROM galery WHERE id = '" . $_GET['id'] . "' ");
    ...
    <div class="box-body">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!in_array($formatfile, $allowedtype)) {
                ...
                $update = mysqli_query($conn, "UPDATE galery SET
                nama = '" . $nama . "',
            ...
            ");
                if ($update) {
                    echo " <script>window.location = './admin-galery.php?msg= Berhasil Edit Data'</script>";
                } else {
