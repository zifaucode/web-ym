...
<div class="box box-warning">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Gambar Slide 3</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        <form role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="gambar_slide1" required>
            </div>
        ...
        if (isset($_POST['submit'])) {
            $filename = $_FILES['gambar_slide1']['name'];
            $tmpname = $_FILES['gambar_slide1']['tmp_name'];
            $filesize = $_FILES['gambar_slide1']['size'];
